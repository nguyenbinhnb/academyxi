...
class Test_001_Frequent_Failures:
    ...
    def test_001_frequent_failures_on_home_page(self):
        ...
        self.basePage.verify_broken_images(self.basePage)
    #
    @pytest.hookimpl(hookwrapper=True)
    # @pytest.mark.smoke
    ...
    def test_004_frequent_failures_on_courses_page(self):
        ...
        self.basePage = BasePage(self.driver)
        self.driver.get("https://academyxi.com/online-courses/customer-experience/")
        ...
        self.driver.get("https://academyxi.com/online-courses/customer-experience/elevate-self-paced/")
    ...
    def test_006_frequent_failures_on_landing_page(self):
        ...
        self.driver.get("https://academyxi.com/lp/ux-ui-online/")
