...
class Test_001_Frequent_Failures:
    ...
    def test_004_frequent_failures_on_courses_page(self):
        ...
        self.basePage.verify_broken_images(self.baseURL+"online-courses/customer-experience/")
        ...
        self.basePage.verify_broken_images(self.baseURL+"online-courses/customer-experience/elevate-self-paced/")
    ...
    def test_005_frequent_failures_on_buy_now_page(self):
        ...
        self.basePage.verify_broken_images(self.baseURL+"buy-now/")
    ...
    def test_006_frequent_failures_on_landing_page(self):
        ...
        self.basePage.verify_broken_images(self.baseURL+"lp/software-engineering-online/")
        self.logger.info("Verify broken images on UX UI Online Landing page")
        self.driver.get(self.baseURL+"lp/ux-ui-online/")
        self.basePage.verify_broken_images(self.baseURL+"lp/ux-ui-online/")
