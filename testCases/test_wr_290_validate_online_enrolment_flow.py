...
class Test_001_validate_online_enrolment_flow:
    ...
    def test_001_validate_online_enrolment_flow(self):
        self.logger.info("Test_001_enrol_course")
        ...
        self.onlineCoursesNewPage.click_learn_more_button("/online-courses/ux-ui-design-new/")
        time.sleep(3)
        self.uxuiDesignNewPage = UXUIDesignNewPage(self.driver)
        self.uxuiDesignNewPage.click_enrol_now_button("1")
        time.sleep(3)
