...
class ElevateSelfPacedPage(BasePage):
    ...
    accordion_sub_content = "(//a[@class='panel-title']//parent::div//following-sibling::div//ul//span)[{}]"
    ...
    def verify_accordions_2(self):
        ...
        for module in module_list:
            ...
            # sub_content_list = self.driver.find_elements(By.XPATH, self.accordion_sub_content.format(module_number))
            # time.sleep(1)
            # for sub_content in sub_content_list:
            #     sub_content_value = sub_content.text
            #     time.sleep(1)
